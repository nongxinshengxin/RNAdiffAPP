  ...
  navbarPage(title=div(a("RNAdiff v1.0.0")),
             ...
             tabPanel("Volcanoplot",sidebarLayout(
               ...
               mainPanel(splitLayout(div(helpText("Show the results in this view."),
                                         plotOutput("plot1"),helpText("Show preview of input data"),tableOutput("text1")),div(colourpicker::colourInput("col1","Select up genes color","red"),
                                                                                                                              colourpicker::colourInput("col2","Select nosig genes color","#00B2FF"),
                                                                                                                              colourpicker::colourInput("col3","Select down genes color","orange"),
               ...
               mainPanel(
                 splitLayout(
                   ...
                   div(colourpicker::colourInput("col_tp1","Select higher value color","red"),
                       ...
                       fluidRow(column(6,checkboxInput('row_c', 'Row cluster?', TRUE)),
                                column(6,checkboxInput('col_c', 'Col cluster?', TRUE))),
